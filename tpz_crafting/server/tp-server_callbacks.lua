...
exports.tpz_core:rServerAPI().addNewCallBack("tpz_crafting:getItemsList", function(source, cb)

  while not LoadedItemsList do
    Wait(250)
  end
...
exports.tpz_core:rServerAPI().addNewCallBack("tpz_crafting:startedCraftingRecipe", function(source, cb, data)
...
exports.tpz_core:rServerAPI().addNewCallBack("tpz_crafting:getCraftingLocationData", function(source, cb, data)
...
exports.tpz_core:rServerAPI().addNewCallBack("tpz_crafting:getCraftingBookMetadata", function(source, cb, data)
  local _source  = source
...
exports.tpz_core:rServerAPI().addNewCallBack("tpz_crafting:startReadingRecipe", function(source, cb, data)
  local _source = source
...
exports.tpz_core:rServerAPI().addNewCallBack("tpz_crafting:startPlacedObjectPickupAction", function(source, cb, data)
  local _source = source
